...
import (
	...
	daemonTesting "github.com/daemgo/gopkg/pkg/testing"
)

func TestCamelCase(t *testing.T) {
	t.Parallel()

	assert := daemonTesting.NewAssert(t, "TestCamelCase")
...
func TestCapitalize(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestCapitalize")
...
func TestKebabCase(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestKebabCase")
...
func TestUpperKebabCase(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestUpperKebabCase")
...
func TestSnakeCase(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestSnakeCase")
...
func TestUpperSnakeCase(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestUpperSnakeCase")
...
func TestUpperFirst(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestLowerFirst")
...
func TestPad(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestPad")
...
func TestPadEnd(t *testing.T) {
	assert := daemonTesting.NewAssert(t, "TestPadEnd")
...
func TestPadStart(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestPadStart")
...
func TestBefore(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestBefore")
...
func TestBeforeLast(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestBeforeLast")
...
func TestAfter(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestAfter")
...
func TestAfterLast(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestAfterLast")
...
func TestIsString(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestIsString")
...
func TestReverse(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestReverse")
...
func TestWrap(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestWrap")
...
func TestUnwrap(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestUnwrap")
...
func TestSplitEx(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestSplitEx")
...
func TestSubstring(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestSubstring")
...
func TestSplitWords(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestSplitWords")
...
func TestRemoveNonPrintable(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestRemoveNonPrintable")
...
func TestStringToBytes(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestStringToBytes")
...
func TestBytesToString(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestBytesToString")
...
func TestIsBlank(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestIsBlank")
...
func TestHasPrefixAny(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestHasPrefixAny")
	str := "foo bar"
...
func TestHasSuffixAny(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestHasSuffixAny")
	str := "foo bar"
...
func TestIndexOffset(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestIndexOffset")
...
func TestReplaceWithMap(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestReplaceWithMap")
...
func TestTrim(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestTrim")
...
func TestContainsAll(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestContainsAll")
...
func TestContainsAny(t *testing.T) {
	...
	assert := daemonTesting.NewAssert(t, "TestContainsAny")
...
func TestRemoveWhiteSpace(t *testing.T) {
	assert := daemonTesting.NewAssert(t, "TestRemoveWhiteSpace")
